  ...
  <div class="container">
    ...
    <el-card>
        <el-row>
            ...
            <el-col :span="8">
                <el-input placeholder="请输入内容" v-model="page.query" @keydown.enter.native="getArticleList" clearable @clear="getArticleList()">
         ...
         border stripe>
            <el-table-column type="expand">
                <template slot-scope="scope">
                    ...
                    <el-row>
                        <SubComment :articleId="scope.row.id"/>
                    </el-row>
                </template>
            </el-table-column>
